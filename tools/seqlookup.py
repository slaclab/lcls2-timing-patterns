...
def seq_lookup(arg):
    ...
    d = {'0 Hz'       :{'instr':['Branch.unconditional(0)'],
         ...
         '100 Hz'     :{'instr':['BeamRequest(0)','FixedRateSync("100H",1)','Branch.unconditional(0)'],
                        'async_start':1},
         '120 Hz'     :{'instr':['BeamRequest(0)','FixedRateSync("70kH",560)','Branch.unconditional(0)',
	 ...
	 '23 kHz'     :{'instr':['BeamRequest(0)','FixedRateSync("910kH",40)','Branch.unconditional(0)',
         ...
         '119 Hz ACH' :{'instr':[f'ACRateSync({SoftTsm},"1H",1)',f'ACRateSync({HardTsm},"1H",1)','BeamRequest(0)',
                                 ...
                                 'Branch.unconditional(0)'],
                        'async_start':0},
         '120 Hz SimAC' : {'instr':['BeamRequest(0)','FixedRateSync("70kH",583)',
                                    'BeamRequest(0)','FixedRateSync("70kH",583)',
                                    'BeamRequest(0)','FixedRateSync("70kH",584)','Branch.unconditional(0)',
                                    'FixedRateSync("1H",1)','Branch.unconditional(0)'],
                           'async_start':7},
         '119 Hz SimAC' : {'instr':['FixedRateSync("70kH",583)',
                                    'BeamRequest(0)','FixedRateSync("70kH",583)',
                                    'BeamRequest(0)','FixedRateSync("70kH",584)',
                                    'BeamRequest(0)','FixedRateSync("70kH",583)',
                                    'BeamRequest(0)','FixedRateSync("70kH",583)',
                                    'BeamRequest(0)','FixedRateSync("70kH",584)','Branch.conditional(line=5, counter=0, 38)',
                                    'Branch.unconditional(0)',
                                    'FixedRateSync("1H",1)','Branch.unconditional(0)'],
                           'async_start':13},
         '60 Hz SimAC' : {'instr':['FixedRateSync("70kH",583)',
                                   'BeamRequest(0)','FixedRateSync("70kH",583)',
