    ...
    d = {'0 Hz'       :{'desc':'No rate',
	 ...
	 '23 kHz'     :{'desc':'23 kHz syncd to 10H marker',
         ...
         '119 Hz ACS' :{'desc':'119 Hz power aligned Soft TS',
                        'instr':[f'ACRateSync({BothTsm},"60H",1)','BeamRequest(0)','Branch.conditional(0,0,117)',
                                 f'ACRateSync({SoftTsm},"1H",1)','BeamRequest(0)',f'ACRateSync({HardTsm},"1H",1)',
                                 'Branch.unconditional(0)'],
                        'async_start':3},
...
#                        'async_start':0},
                        'instr':[f'ACRateSync({BothTsm},"60H",1)','BeamRequest(0)','Branch.conditional(0,0,117)',
                                 f'ACRateSync({SoftTsm},"1H",1)',f'ACRateSync({HardTsm},"1H",1)','BeamRequest(0)',
                                 'Branch.unconditional(0)'],
                        'async_start':3},
