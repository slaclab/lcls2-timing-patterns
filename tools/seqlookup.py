def seq_lookup(name):
    d = {'0 Hz'       :['Branch.unconditional(0)'],
         ...
         '200 Hz'     :['BeamRequest(0)','FixedRateSync(3,5)','Branch.unconditional(0)'],
         ...
         '1.4 kHz'    :['BeamRequest(0)','FixedRateSync(1,50)','Branch.unconditional(0)'],
         ...
         '46 kHz'     :['BeamRequest(0)','FixedRateSync(0,20)','Branch.unconditional(0)'],
